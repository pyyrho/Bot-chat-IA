...
class RevolutxBot(commands.Bot):
    ...
    async def on_guild_join(self, guild: discord.Guild) -> None:
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                "**Acadêmico pesado**: use `/estudar` ou `/analisar-argumento`.\n"
                "**Personalização**: use `/perfil-ia` para definir seu estilo de resposta.\n"
                "**Administração**: use `/status-ia` para ver performance, cache e biblioteca.\n\n"
    ...
    async def on_command_error(self, ctx: commands.Context, error: commands.CommandError) -> None:
        ...
        try:
            await ctx.reply("Ocorreu um erro ao executar esse comando.", mention_author=False)
        except Exception:
            pass
