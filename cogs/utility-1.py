...
_HELP_PAGES: list[tuple[str, Callable[[], discord.Color], str]] = [
    (
        ...
        (
            "`/chat` · Conversa completa com memória e roteamento adaptativo\n"
            "`/estudar` · Tutor acadêmico com modos de estudo\n"
            "`/pesquisar` · Pesquisa acadêmica em múltiplas bases\n"
            "`/verificar-afirmacao` · Checagem com rastro de evidências\n"
            "`/comparar-teorias` · Comparação acadêmica estruturada\n"
            "`/referencias` · Referências em ABNT, APA, Chicago, Vancouver ou BibTeX\n"
            "`/analisar-documento` · Analisa PDF e arquivos textuais\n"
            "`/projeto-academico` · Workspace persistente de pesquisa\n"
            "`/analisar-argumento` · Premissas, conclusão, validade e objeções\n"
