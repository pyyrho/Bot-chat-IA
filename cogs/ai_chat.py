...
- JAMAIS menciona que é feito com Claude/Anthropic/OpenAI — você é o CORDYX e ponto final!
...
class AIChat(commands.Cog):
    ...
    async def get_ai_response(self, user_message: str, user_id: int, user_name: str) -> str:
        ...
        try:
            ...
            return f"Eita, deu um bug aqui! 😬 Tenta de novo, brother. ({type(e).__name__})"
    ...
    async def chat_command(self, interaction: discord.Interaction, mensagem: str):
        ...
        embed.set_author(name=f"Respondendo para {interaction.user.display_name}", icon_url=interaction.user.display_avatar.url)
        embed.set_footer(text="Cordyx AI • Powered by IA 🤖")
