...
class HelpView(discord.ui.View):
    ...
    @discord.ui.button(label="Anterior", style=discord.ButtonStyle.secondary, emoji="<:1000032308:1508193552004546590>")
    async def btn_prev(self, interaction: discord.Interaction, button: discord.ui.Button) -> None:
        self.page -= 1
        self._update_buttons()
        await interaction.response.edit_message(embed=self.build_embed(), view=self)

    @discord.ui.button(label="Próxima", style=discord.ButtonStyle.secondary, emoji="<:1000032309:1508193593439949053>")
...
class Utility(commands.Cog):
    ...
    async def botinfo(self, interaction: discord.Interaction) -> None:
        ...
        embed = discord.Embed(
            ...
            description=(
                f"Olá! Eu sou o **{bot_name}**, um bot de IA para conversar, estudar, "
                "organizar servidores e cuidar da moderação com mais inteligência.\n\n"
                "Tenho comandos para **Utilidades**, **Moderação**, **IA**, lembretes, enquetes, "
                "informações de usuário/servidor e muito mais.\n\n"
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                f"<:1000032053:1507947052183584910> Meu desenvolvedor configurou meu núcleo para funcionar com **Python** e **discord.py**.\n"
                f"<:1000032072:1507947958723809340> Minha IA de utilidades está usando o modelo `{AI_MODEL}`.\n"
                f"<:1000032077:1507948183290904736> Estou online há **{_uptime_str()}**.\n\n"
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                f"• Fui desenvolvido com a linguagem **Python** `{platform.python_version()}`\n"
                f"• Atualmente estou em **{guilds:,}** servidor(es)\n"
                f"• Eu acompanho **{members:,}** usuário(s)\n"
                f"• Tenho **{cmds}** comando(s) sincronizado(s)\n"
                f"• Monitoro **{channels:,}** canal(is)\n\n"
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                "Como eu fico online 24/7?\n"
                "• Eu fico ativo enquanto minha hospedagem e minhas variáveis de ambiente estiverem funcionando certinho."
            ),
            color=color,
            timestamp=datetime.now(timezone.utc),
        )
        ...
        view.add_item(
            discord.ui.Button(
                ...
                emoji="<:1000032063:1507947553654833232>",
            )
        )
        view.add_item(
            discord.ui.Button(
    ...
    async def lembrete(
        ...
        if minutos < 1 or minutos > 10080:
            ...
            return
        await interaction.response.send_message(
            f"<:1000032060:1507947421911613560> Lembrete definido! Vou te avisar em **{minutos} minuto(s)**.", ephemeral=True
        )
